...
class AdminUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post admin_users_url, params: { admin_user: { contact_no: @admin_user.contact_no, email: @admin_user.email, name: @admin_user.name, password_digest: @admin_user.password_digest } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { contact_no: @admin_user.contact_no, email: @admin_user.email, name: @admin_user.name, password_digest: @admin_user.password_digest } }
